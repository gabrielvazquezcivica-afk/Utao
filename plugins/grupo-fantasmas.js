...
var handler = async (m, { conn, text, participants, args, command, isAdmin }) => {

if (!isAdmin)
    return conn.reply(
        m.chat,
        '🎅❌ *Ho ho ho…* Solo los **admins del Polo Norte** pueden detectar o expulsar fantasmas 🎄👻',
        m
    )
...
export default handler    return conn.reply(
        m.chat,
        `🎄✨ *¡Milagro Navideño!* ✨🎄\n\n🎅 Santa revisó la lista y...\n🎁 *Este grupo está activo, no hay fantasmas*`,
        m
    )
