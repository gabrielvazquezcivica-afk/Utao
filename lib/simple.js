...
// ===== ANTI RATE LIMIT GLOBAL =====
global.sendQueue = global.sendQueue || Promise.resolve()
...
export function makeWASocket(connectionOptions, options = {}) {
  ...
  // ===== SAFE SEND (ANTI RATE LIMIT) =====
  conn.safeSend = async function (...args) {
    global.sendQueue = global.sendQueue.then(async () => {
      await delay(1300)
      return conn.sendMessage(...args)
    }).catch(() => {})
    return global.sendQueue
  }
  // ======================================
